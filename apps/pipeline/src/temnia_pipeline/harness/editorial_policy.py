...
EditorialPolicy = Literal["standalone-topics/3", "standalone-topics/4", "standalone-topics/5"]
...
TOPIC_POLICIES = frozenset(
    {TOPIC_SELECTION_POLICY_V3, TOPIC_SELECTION_POLICY_V4, TOPIC_SELECTION_POLICY_V5}
)
