...
class TopicEditorialPatchActivities:
    ...
    async def prepare(self, command: TopicEditorialPatchInput) -> PreparedReviewMutation:
        ...
        try:
            ...
            if metadata.get("selectionArtifactId"):
                ...
                message = "The correction has no selection lineage."
                raise HarnessValidationError(message)  # noqa: TRY301
            compiled = compile_topics_v3(
                evidence,
                patched.proposal,
